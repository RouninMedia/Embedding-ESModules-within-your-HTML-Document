...
Once the **HTML Document** contains one or more `<script type="module/embedded" id="example-id">` elements, any of them can be explicitly activated via the asynchronous `parseEmbeddedModule()` function:
